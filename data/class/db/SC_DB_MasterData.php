...
class SC_DB_MasterData {
    ...
    public $columns_vn = array('id', 'name_vn', 'rank', 'remarks');
    public $arrVnMasterDataName = array('mtb_category', 'mtb_city', 'mtb_currency', 'mtb_education', 'mtb_employment_status', 'mtb_mail_magazine_type', 'mtb_marital_status', 'mtb_object', 'mtb_position', 'mtb_product_list_max', 'mtb_pref', 'mtb_process', 'mtb_region', 'mtb_reminder', 'mtb_salary_type', 'mtb_status', 'mtb_welfare');
