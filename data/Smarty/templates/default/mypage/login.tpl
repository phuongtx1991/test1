        ...
        <form name="login_mypage" id="login_mypage" method="post" action="<!--{$smarty.const.HTTPS_URL}-->frontparts/login_check.php" onsubmit="return eccube.checkLoginFormInputted('login_mypage')">
            ...
            <div class="login_area">
                ...
                <p>
                    ...
                    ※メールアドレスを忘れた方は、お手数ですが、<a href="<!--{$smarty.const.HTTPS_URL}-->forgot/mail.php" onclick="eccube.openWindow('<!--{$smarty.const.HTTPS_URL}-->forgot/mail.php','forget','600','470',{scrollbars:'no',resizable:'no'}); return false;" target="_blank">お問い合わせページ</a>からお問い合わせください。
                </p>
            </div>
