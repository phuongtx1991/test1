...
<table>
    ...
    <col width="70%" />
    <tr>
        <th>希望仕事<span class="attention"> *</span></th>
        <td>
            ...
            <div class="checkInsideSelect">
                ...
                <a href="#"><!--{if $arrForm.desired_work[0] == ''}-->希望仕事を選択<!--{elseif $count == 1}--><!--{$arrCategory[$first]}--><!--{else}-->選択条件<!--{$count}--><!--{/if}--></a>
                <div class="checkList">
                    <!--{if $arrForm.current_address}-->
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="current_salary" value="<!--{$arrForm.current_salary|h}-->" class="box60" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.current_salary != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/>円
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="desired_salary" value="<!--{$arrForm.desired_salary|h}-->" class="box60" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.desired_salary != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/>円
            <span class="attention"> (半角数字で入力)</span>
        </td>
    </tr>
    <tr>
