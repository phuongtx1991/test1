...
<!--{$arrForm.name01.value}--> <!--{$arrForm.name02.value}--> 様

以下のお問い合わせを受付致しました。
確認次第ご連絡いたしますので、少々お待ちください。

■お名前　：<!--{$arrForm.name01.value}--> <!--{$arrForm.name02.value}--><!--{if $arrForm.kana01.value}-->(<!--{$arrForm.kana01.value}--> <!--{$arrForm.kana02.value}-->)<!--{/if}--> 様
