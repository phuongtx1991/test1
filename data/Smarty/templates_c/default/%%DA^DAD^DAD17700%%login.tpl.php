<?php /* Smarty version 2.6.27, created on 2017-12-25 15:22:08
...
','forget','600','460',{scrollbars:'no',resizable:'no'}); return false;" target="_blank">こちら</a>からパスワードの再発行を行ってください。<br />
                    ※メールアドレスを忘れた方は、お手数ですが、<a href="<?php echo ((is_array($_tmp=@HTTPS_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
forgot/mail.php','forget','600','470',{scrollbars:'no',resizable:'no'}); return false;" target="_blank">お問い合わせページ</a>からお問い合わせください。
                </p>
            </div>
            ...
            <div class="login_area">
                ...
                <p class="inputtext">会員登録をすると便利なMyページをご利用いただけます。<br />
                    会員登録することにより、ご希望のお仕事を紹介することができます。
                </p>
                <div class="inputbox">
                    <div class="btn_area">
                        <ul>
