<?php /* Smarty version 2.6.27, created on 2017-12-08 13:13:02
         compiled from mypage/cv_confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mypage/cv_confirm.tpl', 26, false),array('modifier', 'h', 'mypage/cv_confirm.tpl', 26, false),)), $this); ?>
...
" />
            <input type="hidden" name="mode" value="<?php if (((is_array($_tmp=$this->_tpl_vars['content'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'info'): ?>complete<?php else: ?>cv_complete<?php endif; ?>" />
...
" />
            ...
            <?php if (((is_array($_tmp=$this->_tpl_vars['content'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'info'): ?>
...
img/button/btn_back.jpg" alt="戻る" /></a>
                    </li>
                    <li>
