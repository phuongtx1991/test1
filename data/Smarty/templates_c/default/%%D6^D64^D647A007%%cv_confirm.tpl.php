<?php /* Smarty version 2.6.27, created on 2018-01-12 16:27:03
         compiled from entry/cv_confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'entry/cv_confirm.tpl', 25, false),array('modifier', 'h', 'entry/cv_confirm.tpl', 25, false),)), $this); ?>
...
<div id="undercolumn">
    <div id="undercolumn_entry">
        ...
        <p>下記の内容で送信してもよろしいでしょうか？<br />
            よろしければ、一番下の「<?php if (((is_array($_tmp=$this->_tpl_vars['applyProductId'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) > 0): ?>応募を完了する<?php else: ?>完了ページへ<?php endif; ?>」ボタンをクリックしてください。</p>
