<?php /* Smarty version 2.6.27, created on 2017-11-08 13:12:30
         compiled from products/complete.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/complete.tpl', 26, false),array('modifier', 'h', 'products/complete.tpl', 32, false),)), $this); ?>
...
'); eccube.setModeAndSubmit('search','',''); return false;"><span class="btn-prev">検索結果へ戻る</span></a></li>
                ...
                <li><a class="btn-action" href="?" onclick="eccube.setModeAndSubmit('pre_edit', 'product_id', '<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm']['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;"><span class="btn-next">この求人の規格を登録する</span></a></li>
                <?php endif; ?>
            </ul>
        </div>
