<?php /* Smarty version 2.6.27, created on 2018-05-24 12:14:02
         compiled from products/upload_csv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/upload_csv.tpl', 26, false),)), $this); ?>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <?php endif; ?>
                    <input type="file" name="csv_file" size="40" /><span class="attention">(1行目タイトル行)(最大アップロードサイズ:<?php echo ((is_array($_tmp=$this->_tpl_vars['max_upload_csv_size'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)</span>
                </td>
            </tr>
            <tr>
