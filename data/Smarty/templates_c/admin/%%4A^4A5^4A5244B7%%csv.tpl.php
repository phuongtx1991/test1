<?php /* Smarty version 2.6.27, created on 2018-05-10 15:06:31
         compiled from contents/csv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'contents/csv.tpl', 25, false),array('modifier', 'h', 'contents/csv.tpl', 60, false),array('modifier', 'sfGetErrorColor', 'contents/csv.tpl', 68, false),array('function', 'html_options', 'contents/csv.tpl', 69, false),)), $this); ?>
...
" />
    <div id="admin-contents" class="contents-main">
        ...
        <div class="ms2side__area">
            ...
            <select multiple="multiple" name="output_list[]" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['output_list'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
