<?php /* Smarty version 2.6.27, created on 2017-11-06 17:35:31
         compiled from basis/point.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/point.tpl', 26, false),array('modifier', 'h', 'basis/point.tpl', 37, false),array('modifier', 'sfGetErrorColor', 'basis/point.tpl', 37, false),)), $this); ?>
...
" size="6" class="box6" />
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('point_form', '<?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
