<?php /* Smarty version 2.6.27, created on 2017-11-06 15:52:34
         compiled from /var/www/testjp.hyperion-job.jp/html/../data/Smarty/templates/admin/total/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/testjp.hyperion-job.jp/html/../data/Smarty/templates/admin/total/subnavi.tpl', 27, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=@ADMIN_DIR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
total/<?php echo ((is_array($_tmp=@DIR_INDEX_PATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
?page=products"><span>求人別集計</span></a></li>
