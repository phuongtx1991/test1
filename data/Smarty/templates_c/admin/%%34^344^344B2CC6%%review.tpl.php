<?php /* Smarty version 2.6.27, created on 2017-11-08 16:22:41
         compiled from products/review.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/review.tpl', 27, false),array('modifier', 'h', 'products/review.tpl', 35, false),array('modifier', 'sfGetErrorColor', 'products/review.tpl', 65, false),array('modifier', 'sfDispDBDate', 'products/review.tpl', 151, false),array('function', 'html_checkboxes', 'products/review.tpl', 48, false),array('function', 'html_options', 'products/review.tpl', 54, false),)), $this); ?>
...
?>
                        <tr>
                            ...
                            <td class="menu"><a href="javascript:;" onclick="eccube.changeAction('./review_edit.php'); eccube.setModeAndSubmit('','review_id','<?php echo ((is_array($_tmp=$this->_tpl_vars['arrReview'][$this->_sections['cnt']['index']]['review_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">編集</a></td>
                            <td class="menu"><a href="javascript:;" onclick="eccube.setModeAndSubmit('delete','review_id','<?php echo ((is_array($_tmp=$this->_tpl_vars['arrReview'][$this->_sections['cnt']['index']]['review_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
