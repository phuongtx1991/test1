<?php /* Smarty version 2.6.27, created on 2017-11-08 13:45:20
         compiled from system/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/index.tpl', 26, false),array('modifier', 'h', 'system/index.tpl', 57, false),)), $this); ?>
...
','member_edit','620','450'); return false;">編集</a></td>
                <td align="center"><?php if (((is_array($_tmp=$this->_tpl_vars['workmax'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) > 1): ?><a href="#" onclick="eccube.deleteMember(<?php echo ((is_array($_tmp=$this->_tpl_vars['list_data'][$this->_sections['data']['index']]['member_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
,<?php if (((is_array($_tmp=$this->_tpl_vars['list_data'][$this->_sections['data']['index']]['authority'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_last_admin'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php else: ?>false<?php endif; ?>); return false;">削除</a>
