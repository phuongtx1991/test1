<?php /* Smarty version 2.6.27, created on 2017-11-09 12:51:52
...
" size="6" /></th>
                        <?php if (((is_array($_tmp=$this->_tpl_vars['parent'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ''): ?>
                        <td>
                            親：<select name="<?php echo ((is_array($_tmp=$this->_tpl_vars['parent'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
_id[]" class="box145">
                                <option value="">----</option>
                                <?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrParentMasterData'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrMasterParentData'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
...
" style="" size="60" class="box40" /><?php if (((is_array($_tmp=$this->_tpl_vars['vn'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> <input type="text" name="name_vn[]" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrMasterVnData'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" style="" size="60" class="box40 vn_field" /><?php endif; ?></td>
                    </tr>
...
_id[]" class="box145">
                                <option value="">----</option>
                                <?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrParentMasterData'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>

                            </select>
                    </td>
                    <?php endif; ?>
                    <td>値：<input type="text" name="name[]" style="" size="60" class="box40" /><?php if (((is_array($_tmp=$this->_tpl_vars['vn'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> <input type="text" name="name_vn[]" style="" size="60" class="box40 vn_field" /><?php endif; ?></td>
                </tr>
            </table>
            <div class="btn-area">
                <ul>
