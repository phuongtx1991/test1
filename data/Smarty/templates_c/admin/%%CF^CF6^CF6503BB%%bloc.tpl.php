<?php /* Smarty version 2.6.27, created on 2017-11-06 15:52:53
...
" >編集</a>
                    ...
                    <td class="center">
                        <?php if (((is_array($_tmp=$this->_tpl_vars['item']['deletable_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?>
                            <a href="javascript:;" onclick="eccube.fnFormModeSubmit('form_bloc','delete','bloc_id',<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['bloc_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
);">削除</a>
