<?php /* Smarty version 2.6.27, created on 2017-11-08 13:11:28
         compiled from customer/search_client.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/search_client.tpl', 44, false),array('modifier', 'h', 'customer/search_client.tpl', 57, false),array('function', 'sfSetErrorStyle', 'customer/search_client.tpl', 57, false),)), $this); ?>
...
function func_submit(client_id){
    var fm = window.opener.document.form1;
    window.opener.$('#category_id').children().prop('selected', 'selected');
    fm.edit_client_id.value = client_id;
    fm.mode.value = 'search_client';
    fm.anchor_key.value = 'client_area';
    fm.submit();
    window.close();
    return false;
}
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td width="287" colspan="2">
                <?php $this->assign('key', 'search_client_id'); ?>
...
件が該当しました。<?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_strnavi'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</p>
            <?php endif; ?>
...
$this->_sections['cnt']['loop'] = is_array($_loop=((is_array($_tmp=$this->_tpl_vars['arrClient'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
            <!--▼会員<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
-->
            <tr>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrClient'][$this->_sections['cnt']['index']]['client_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrClient'][$this->_sections['cnt']['index']]['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
                <td align="center"><a href="" onclick="return func_submit(<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrClient'][$this->_sections['cnt']['index']]['client_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
)">決定</a></td>
            </tr>
            <!--▲会員<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
-->
