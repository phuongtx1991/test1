<?php /* Smarty version 2.6.27, created on 2017-11-06 15:52:56
         compiled from design/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/index.tpl', 3, false),array('modifier', 'h', 'design/index.tpl', 3, false),array('modifier', 'strlen', 'design/index.tpl', 364, false),)), $this); ?>
...
<script type="text/javascript" src="<?php echo ((is_array($_tmp=@ROOT_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.ui/jquery.ui.mouse.min.js"></script>
<script type="text/javascript" src="<?php echo ((is_array($_tmp=@ROOT_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.ui/jquery.ui.sortable.min.js"></script>
...
">編集</a>
                ...
                <td class="center">
                    <?php if (((is_array($_tmp=$this->_tpl_vars['item']['edit_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?>
                        <a href="#" onclick="fnTargetSelf(); eccube.fnFormModeSubmit('form1','delete','page_id','<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
'); return false;">削除</a>
                    <?php endif; ?>
                </td>
            </tr>
