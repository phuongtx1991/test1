<?php /* Smarty version 2.6.27, created on 2018-05-24 13:46:21
         compiled from mail/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/index.tpl', 27, false),array('modifier', 'default', 'mail/index.tpl', 47, false),array('modifier', 'h', 'mail/index.tpl', 75, false),array('modifier', 'sfDispDBDate', 'mail/index.tpl', 117, false),array('function', 'html_radios', 'mail/index.tpl', 39, false),array('function', 'html_options', 'mail/index.tpl', 57, false),)), $this); ?>
...
?>
 ...
 <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrResults'][$this->_sections['i']['index']]['name02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
                ...
                <td class="center"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrHtmlmail'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, 'なし') : smarty_modifier_default($_tmp, 'なし')); ?>
</td>
