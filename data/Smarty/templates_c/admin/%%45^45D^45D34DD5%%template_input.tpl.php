<?php /* Smarty version 2.6.27, created on 2018-01-23 11:57:14
         compiled from mail/template_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/template_input.tpl', 26, false),array('modifier', 'h', 'mail/template_input.tpl', 28, false),array('function', 'sfSetErrorStyle', 'mail/template_input.tpl', 34, false),array('function', 'html_radios', 'mail/template_input.tpl', 34, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['body'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.fnFormModeSubmit('form1', '<?php echo ((is_array($_tmp=$this->_tpl_vars['mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
