<?php /* Smarty version 2.6.27, created on 2017-11-08 12:34:49
         compiled from contents/recommend.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'contents/recommend.tpl', 58, false),array('modifier', 'h', 'contents/recommend.tpl', 58, false),array('modifier', 'sfNoImageMainList', 'contents/recommend.tpl', 115, false),array('modifier', 'sfGetErrorColor', 'contents/recommend.tpl', 131, false),array('modifier', 'sfGetEnabled', 'contents/recommend.tpl', 131, false),)), $this); ?>
...
function lfnCheckSubmit( fm ){
    ...
    if ( fm["comment_vn"] && !fm["comment_vn"].value ){
        if ( err ) err += '';
        err += 'コメント_VNを入力して下さい。';
    }
...
?>
    <a name="recommend_<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" id="recommend_<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"></a>
    <div class="recommend-product <?php if (((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['status'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '2'): ?>hidden<?php endif; ?>">
        <table class="list center recommend-table">
            ...
            <tr>
                <td>おすすめ求人(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)</td>
...
" width="100" height="100" />
                                ...
                                <div class="table-detail">
                                    <div class="detail-name">
                                        求人名： <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
" method="post" action="?#recommend_<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
                                            ...
                                            <br />
                                            <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_sections['cnt']['iteration']]['comment_vn'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                                            <textarea class="vn_field" name="comment_vn" cols="45" rows="4" style="width: 586px; height: 80px; <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_sections['cnt']['iteration']]['comment_vn'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetEnabled', true, $_tmp) : SC_Utils_Ex::sfGetEnabled($_tmp)); ?>
><?php echo "\n"; ?>
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['comment_vn'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</textarea>
                                        </form>
                                    </div>
                                </div>
...
'); return false;" target="_blank"><span class="btn-next">求人を選択する</span></a>
                            <form name="form<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" id="form<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" method="post" action="?#recommend_<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">
...
, 'mode', 'delete', '削除します。宜しいですか' )">削除</a>
                ...
                <td>
                                        <?php if (((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != 1 && ((is_array($_tmp=$this->_tpl_vars['arrItems'][$this->_sections['cnt']['iteration']]['best_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
...
'); return false;">下へ</a>
    ...
    <!--▲おすすめ求人<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
-->
    <?php endfor; endif; ?>
</div>