<?php /* Smarty version 2.6.27, created on 2018-01-23 11:57:12
         compiled from mail/template.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/template.tpl', 26, false),array('modifier', 'date_format', 'mail/template.tpl', 49, false),array('modifier', 'h', 'mail/template.tpl', 49, false),)), $this); ?>
...
&amp;<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
">編集</a></td>
                <td><a href="#" onclick="eccube.moveDeleteUrl('?mode=delete&amp;id=<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTemplates'][$this->_sections['data']['index']]['template_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
&amp;<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
=<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">削除</a></td>
                <td><a href="#" onclick="eccube.openWindow('./preview.php?mode=template&amp;template_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTemplates'][$this->_sections['data']['index']]['template_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
&amp;<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
=<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
','preview','650','700',{menubar:'no'}); return false;" target="_blank">プレビュー</a></td>
            </tr>
            <?php endfor; endif; ?>
        </table>
    </div>
